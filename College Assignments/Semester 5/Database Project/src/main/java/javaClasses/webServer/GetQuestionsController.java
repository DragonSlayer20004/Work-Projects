...
import static javaClasses.databaseClasses.GetQuestionsRetrieval.GetQuestions;

@WebServiceProvider
@ServiceMode(value = Service.Mode.PAYLOAD)
public class GetQuestionsController implements Provider<Source> {
