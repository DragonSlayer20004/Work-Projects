...
import javaClasses.databaseClasses.QuestionUpdateDepository;
...
public class UpdateQuestionsController implements Provider<Source> {
    ...
    public Source invoke(Source request) {
        ...
        try {
            switch (requestData.getQuestionType()) {
                case "multichoice":
                    creationSuccess = QuestionUpdateDepository.updateMultichoiceQuestion(
                ...
                case "fillInTheBlank":
                    creationSuccess = QuestionUpdateDepository.updateFillInTheBlankQuestion(
                            requestData.getQuestionID(),
                            requestData.getQuestionDescription(),
                ...
                case "dragAndDrop":
                    creationSuccess = QuestionUpdateDepository.updateDragAndDropQuestion(
                            requestData.getQuestionID(),
                            requestData.getQuestionDescription(),
                            requestData.getCorrectAnswer(),
