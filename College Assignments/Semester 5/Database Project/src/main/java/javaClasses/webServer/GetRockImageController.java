...
import static javaClasses.databaseClasses.RockImageRetrieval.GetRockInfoById;

@WebServiceProvider
@ServiceMode(value = Service.Mode.PAYLOAD)
public class GetRockImageController implements Provider<Source> {

    public Source invoke(Source request) {
        System.out.println("AM I BEING IN A ROCK NAME THINGY??");
